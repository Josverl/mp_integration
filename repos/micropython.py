"""
MicroPython repository integration configuration.

Repository: micropython/micropython
Fork: josverl/micropython
"""
...
integration_branches = {
    "master_jv": {"target_branch": "master_jv", "sources": BASE},
    "mpremote": {
        ...
        + [
            ...
            (
                "patch/mpremote_transport__quote_path",
                "-Xtheirs",
            ),  # Fix quoting of paths with spaces in mpremote transport
        ],
    },
    "CI": {
    ...
    "docs": {
        ...
        + [
            ...
            (
                17038,
                "-Xtheirs",
            ),  # Document that a Pin can be passed to UART constructor on the ESP32 ports.
